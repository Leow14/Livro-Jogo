...
function inicio() {
    ...
    content.innerHTML = `<div>Seu nome é  ${nome}. E você é um feiticeiro de uma vila pequena, você gosta de viajar pelo continente. Mas você não lembra de ir pra um deserto e muito longe de qualquer mar, e infelizmente é nesse deserto aonde você está agora. Ao seu lado, você encontra um mecanoide, sem bateria, todo quebrado e ao lado dele um mapa que mostra aonde você está e as regiões próximas. E sua casa está MUITO longe. Existem duas cidades próximas de você que te levam para sua cidade natal. Uma das opções é uma cidade fantasma, sem habitantes e bem assustadora, mas com uma estrada que leva você até lá em segurança, e a outra é uma cidade de elfos acolhedores em um bosque próximo, o problema é que essa cidade tem um trajeto perigoso.<b style="font-size: 28px">Qual caminho  ${nome} deve seguir?
        <br>
        <br>
        </b></div> <a><button onclick="bosque_elfos()"> Bosque dos elfos </button></a>
        
        <a><button onclick="cidade_fantasma()"> Cidade Fantasma </button></a>`;
}

//<a><button onclick="()">texto</button></a> <a><button onclick="()">texto</button></a>
function cidade_fantasma() {
    ...
    <b style="font-size: 28px">O que você vai fazer?</b>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="homem_misterioso()">Atravessar a cidade</button></a>
    <br>
    <br>
    <a><button class ="botao" onclick="taverna()">Entrar na taverna</button></a>
    </div>`
}
...
function bosque_elfos() {
    ...
    <b style="font-size: 28px">Você tem que tomar uma decisão rápido, antes que eles te alcancem.</b>
        <br>
        <br>
        <div class="pao"> 
        <button onclick="pantera()">Ir pelo urro estridente.</button>
        <br>
        <br>
        <button onclick="golem()">Seguir pelas rochas pesadas.</button>`
}
...
function taverna() {
    ...
    <b style="font-size: 28px">Aceitar ou não a bebida?</b>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="beber_taverna()">Aceitar</button></a> 
    <br>
    <br>
    <a><button class ="botao" onclick="cassino()">Negar e ir para a próxima cidade</button></a>`
}
...
function homem_misterioso() {
    ...
    <b style="font-size: 28px">Seguir ou não?</b>
    <br>
    <br>
    <div class="pao">
<a><button class ="botao" onclick="conhecer_anciao()">Seguir</button></a>
    <br>
    <br>
<a><button class ="botao" onclick="encontrar_upl()">Correr para o lago</button></a>`
}
...
function pantera() {
    ...
    <b style="font-size: 28px">Você tenta passar correndo, ou tenta ser furtivo?</b>
    <br>
    <br>
    <div class="pao">
    <button onclick="furtivo_pantera()">Ser furtivo</button>
    <br>
    <br>
    <button onclick="correr_pantera()">Correr</button>`
}
...
function golem() {
    ...
    <b style="font-size: 28px">Qual usar?</b>
    <br>
    <br>
    <div class="pao">
    <button onclick="luz_golem()">Raio de luz</button>
    <br>
    <br>
    <button onclick="amizade_golem()">Amizade animal</button>`
}
...
function correr_pantera() {
    ...
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="morrer()">MORTE</button></a>`
...
function furtivo_pantera() {
    ...
    <b style="font-size: 28px">O que fazer?</b>
    <br>
    <br>
    <div class="pao">
<button class ="botao" onclick="amizade_pantera()">Amizade Animal</button><br>
    <br>
    <br>
<button class ="botao" onclick="luz_pantera()">Raio de luz</button></div>`
}
...
function amizade_pantera() {
    ...
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="vila_elfo()">Ir para a vila elfo</button></a>`
    //Ir para os elfos
}
...
function vila_elfo() {
    ...
    <b style="font-size: 28px">O que você vai escolher?</b> 
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="vila_natal()">Ir para a próxima cidade</button></a> 
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="biblioteca()">Ir para a biblioteca</button></a> 
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="roubar_elfo()">Roubar o elfo</button></a>`
}
...
function vila_natal() {
    ...
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="concentrar_vila_natal()">Se concentrar e lembrar dos seus antigos feitiços</button></a> 
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="raio_luz_vila_natal()">Usar raio de luz como um ataque</button></a>`
}
...
function biblioteca() {
    ...
    <b style="font-size: 28px">Como quer testa-los?</b>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="polimorfia()">Feitiço de polimorfia</button></a>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="minecraft()">Feitiço de portal</button></a>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="vila_natal()">Ir para a próxima cidade</button></a>`
...
function beber_taverna() {
    ...
    <br>
    <div class="pao"> 
    <a><button class ="botao" onclick="bater_mesa()">Bater na mesa</button></a>
    <br>
    <br>
    <div class="pao"> 
    <a><button class ="botao" onclick="sair_assustado()">Sair</button></a>
    <br>
    <br>
    <div class="pao"> 
    <a><button class ="botao" onclick="ja_sei_codigo()">Descobri o código!</button></a>`
}
//
//
//
...
function bater_mesa() {
    ...
    <b style="font-size: 28px">Qual floresta ir?</b>
    <br>
    <br>
    <div class="pao"> 
    <a><button class ="botao" onclick="floresta_sem_lago()">Floresta sem lago</button></a>
    <br>
    <br>
    <div class="pao"> 
    <a><button class ="botao" onclick="encontrar_upl()">Floresta com lago</button></a>`
}
function sair_assustado() {
    ...
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="cassino()">Ir para a próxima cidade</button></a>`
    //Ir ao cassino
}
...
function floresta_sem_lago() {
    ...
    <b style="font-size: 28px">Qual flor colocar?</b>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="laranja()">Laranjas</button></a>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="azul()"> Azuis</button></a>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="laranja()">Rosas</button></a>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="laranja()">Verdes</button></a>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="laranja()">Um punhado de grama</button></a>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="laranja()">Amarelas</button></a>`
}
function azul() {
    var fundo = document.getElementById('fundo');
    ...
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="quebrar_maldiçao()">Ir para sua vila natal</button></a>`
...
function quebrar_maldiçao() {
    ...
    <b style="font-size: 28px">Usar ou não o feitiço?</b> 
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="arauto_cosmico()">Usar</button></a> `
}
...
function cassino() {
    ...
    <b style="font-size: 28px">Entrar no cassino?</b>
    <br>
    <br>
    <div class="pao"> 
    <a><button class ="botao" onclick="ganancia_cassino()">Sim</button></a>
    <br>
    <br>
    <div class="pao"> 
    <a><button class ="botao" onclick="ignorar_cassino()">Não</button></a>`
}
...
function conhecer_anciao_parte_dois() {
    ...
    content.innerHTML = `O vulto remove sua capa e revela ser o ancião da vila, Samurai Gomus, mas com muitas cicatrizes e ferimentos mágicos no rosto. Ele abre um portal para você, e diz "Entre, esse portal vai te levar ao campo de batalha, na hora certa, use a magia que te ensinei, infelizmente não poderei acompanhar, usei meus ultimos resquícios de magia para abrir esse portal e te ensinar essas magias. Boa sorte!
        <b style="font-size: 28px">Entrar no portal?</b> 
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="vila_natal_runa()">Entrar no portal</button></a>
    <br>
    <br>
    <div class="pao"> 
    <a><button class ="botao" onclick="cassino()">Negar e seguir para a próxima cidade</button></a>`
}
...
function encontrar_upl() {
    ...
    <b style="font-size: 28px">Enfim, passar os pertences ou não?</b>
        <br>
        <br>
        <div class="pao"> 
        <a><button class ="botao" onclick="ser_roubado_upl()">Aceitar e passar seus pertences</button></a> 
        <br>
        <br>
        <div class="pao">
        <a><button class ="botao" onclick="nao_ser_roubado_upl()">Não passar seus pertences</button></a>`
}
...
function nao_ser_roubado_upl() {
    ...
    <b style="font-size: 28px">Ajudar o morcego com seu dinheiro?</b>
    <br>
    <br>
    <div class="pao"> 
    <a><button class ="botao" onclick="ajudar_morcego()">Sim</button></a>
    <br>
    <br>
    <div class="pao"> 
    <a><button class ="botao" onclick="conhecer_tiao()">Não</button></a>`
}
function ajudar_morcego() {
    ...
    <b style="font-size: 28px">Você aceita?</b> 
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="ser_funcionario_abrofts()">Aceitar</button></a> 
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="conhecer_tiao()">Negar</button></a>`
}
function conhecer_tiao() {
    ...
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="pegar_carona_tiao()">Aceitar</button></a>
    <br>
    <br>
    <div class="pao"> 
    <a><button class ="botao" onclick="cassino()">Negar</button></a>`
...
function pegar_carona_tiao() {
    ...
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="vila_natal()">Seguir</button></a>`
...
function ignorar_cassino() {
    ...
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="vila_natal()">Continuar</button></a>`
    //Ir a vila natal
}
...
function vila_natal_runa() {
    ...
    <b style="font-size: 28px">Entregar a runa</b>, ou lutar?
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="rajada_congelante()">Lutar</button></a>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="entregar_runa()">Entregar</button></a>`
}
...
function concentrar_vila_natal() {
    ...
    <b style="font-size: 28px">Usar o bastão, ou ir para a sua casa?</b>
    <br>
    <br>
    <div class="pao"> 
    <a><button class="botao" onclick="lutar_bastao()">Bastão</button></a>
    <br>
    <br>
    <div class="pao"> 
    <a><button class="botao" onclick="casa_chamas()">Casa</button></a>`
}
...
function casa_chamas() {
    ...
    <b style="font-size: 28px">Pegar o anel, ou o pergaminho?</b>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="anel_portal()">Anel</button></a>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="pergaminho_casa_chamas()">Pergaminho</button></a>`
}
...
function pergaminho_casa_chamas() {
    ...
    <b style="font-size: 28px">Usar o feitiço de fogo, ou o feitiço vil?</b> 
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="raio_vil()">Vil</button></a>
    <br>
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="bola_de_fogo()">Fogo</button></a>`
}
...
function anel_portal() {
    ...
    <br>
    <div class="pao">
    <a><button class ="botao" onclick="portal_pirata()">Gritar PORTAL!</button></a>`
}
